...
- DeepSoCFlow: An open workflow for hardware research in FPGA/ASIC implementation of DNNs
...
- SystemVerilog for ASIC/FPGA Design and verification (Short Course - designed & taught)
